...
import { getNodePath, getNodeAtPath, updateNodeAtPath, mergeNodes } from '../tree';
...
export function connectProperty (ComposedComponent: constructor) {
    return class PropertyConnector extends Component {
        ...
        constructor (props, context) {
            ...
            invariant(context.spectro, 'Spectro context should be provided to connect property');
        }
