...
export default function createEnhancer(spectro: SpectroConfig): Function {
  return function enhance(
    component: Function | ReactClass<any>
  ): ReactClass<any> {
    const ComposedComponent: ReactClass<any> = convertToClassComponent(
      component
    );
    ...
    return class SpectroEnhancer extends ComposedComponent {
      ...
      constructor(props: Props, context: Context) {
        ...
        invariant(
          ...
          `Required \`spectroKey\` prop is missing on ${this.constructor
            .displayName}`
        );
      ...
      componentDidUpdate(
        ...
        if (this.context.spectro.enabled) {
          ...
          const canRestoreSelection =
            this._childrenRef && this._spectroSelection;
      ...
      onDragOver = (event: MouseEvent): void => {
        ...
        this.context.spectro.dragAndDrop = updateDndStateOnOver(
          this,
          spectro,
          event
        );
      ...
      render(): ReactElement<any> {
        ...
        if (this.context.spectro.enabled) {
          const isDragAndDropActive: boolean = Boolean(
            this.context.spectro.dragAndDrop
          );
          ...
          const addHoverStyles: boolean =
            !isDragAndDropActive && hasPointerOver;
